...
export default function ServicesPreview() {
  return (
    <section className="py-16 bg-[#7a3e14] bg-[url('/textures/wood.png')] bg-[length:300px] bg-repeat bg-blend-multiply">
      <div className="flex justify-center">
        ...
        <div className="bg-[#f5f2ee] max-w-6xl w-full p-10 shadow-xl">
          ...
          <div className="flex justify-between items-center mb-10 border-b border-[#8a5a3a] pb-4">
            ...
            <Link
              href="/services"
              className="text-[#8a5a3a] hover:underline"
            >
              view all
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition duration-300 p-4">
              ...
              <Link
                ...
                className="inline-block bg-[#d89a2b] text-white px-4 py-2 text-sm font-semibold hover:bg-[#b8771f] transition"
              >
                READ MORE
              </Link>
            </div>
